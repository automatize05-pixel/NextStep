...
const PLANS = [
  {
    ...
    features: [
      { text: '3 simulações de entrevista/dia', included: true },
      { text: '4 buscas de oportunidades/dia', included: true },
      { text: '3 pesquisas Job Hunter IA/dia', included: true },
      { text: '1 carta de apresentação/dia', included: true },
      { text: '2 análises salariais/dia', included: true },
      { text: 'CV Builder (templates básicos)', included: true },
      { text: 'CRM de Candidaturas', included: true },
      { text: 'Análise de Soft Skills IA', included: false },
      { text: 'Alertas de Vagas por Email', included: false },
      { text: 'Portfólio Público', included: false },
      { text: 'CV Multi-idioma', included: false },
    ]
  },
  {
    id: 'essential',
    ...
    badge: null,
    description: 'Para quem está activo no mercado',
    features: [
      { text: '20 simulações de entrevista/dia', included: true },
      { text: '20 buscas de oportunidades/dia', included: true },
      { text: '15 pesquisas Job Hunter IA/dia', included: true },
      { text: '5 cartas de apresentação/dia', included: true },
      { text: '10 análises salariais/dia', included: true },
      { text: 'CV Builder (todos os templates)', included: true },
      { text: 'LinkedIn Optimizer IA', included: true },
      { text: '2 análises de Soft Skills/dia', included: true },
      { text: 'Alertas de Vagas por Email', included: false },
      { text: 'Portfólio Público', included: false },
      { text: 'CV em Inglês', included: true },
    ]
  },
  {
    id: 'premium',
    ...
    features: [
      { text: '100 simulações de entrevista/dia', included: true },
      { text: 'Pesquisas ilimitadas de oportunidades', included: true },
      { text: '50 pesquisas Job Hunter IA/dia', included: true },
      { text: 'Cartas de apresentação ilimitadas', included: true },
      { text: '50 análises salariais/dia', included: true },
      { text: 'Todos os templates de CV', included: true },
      { text: 'LinkedIn Optimizer IA', included: true },
      { text: '10 análises de Soft Skills/dia', included: true },
      { text: 'Alertas de Vagas por Email (diários)', included: true },
      { text: 'Portfólio Público', included: true },
      { text: 'CV em PT e EN', included: true },
    ]
  },
  {
    id: 'elite',
    ...
    features: [
      ...
      { text: 'Prioridade em novas features', included: true },
      { text: 'Badge Elite no portfólio público', included: true },
      { text: 'Suporte prioritário', included: true },
      { text: 'Acesso antecipado a funcionalidades beta', included: true },
    ]
  }
]
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-slate-500 text-sm">Pagamento via transferência bancária (IBAN). Aprovação em até 24h.</p>
        </div>
