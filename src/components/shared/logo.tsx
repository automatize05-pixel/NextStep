    ...
    <div className={cn("flex items-center gap-2 group cursor-pointer select-none", className)}>
      ...
      {!iconOnly && (
        <span className={cn(
          ...
          Next<span className={cn("italic", white ? "text-white/80" : "text-[#2563EB]")}>Step</span>
        </span>
      )}
    </div>
  )
